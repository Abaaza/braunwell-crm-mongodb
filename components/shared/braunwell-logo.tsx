...
export function BraunwellLogo({ 
  ...
  const dimensions = {
    sm: { width: 94, height: 18 },
    md: { width: 125, height: 24 },
    lg: { width: 150, height: 29 },
    xl: { width: 188, height: 36 }
  }
